...
| D10 | Implemented | [ADR 18](./00_adr/18_FLUSH_SEQUENCE_NOW_DELTA_GRANULARITY_WHEN_MEASURED.md)       | Delta granularity and flush sequence                                             |
...
| D18 | Implemented | [ADR 26](./00_adr/26_RAW_PAYLOAD_BOUNDED_VERBATIM_AND_UNPROTECTED_BY_DECISION.md) | Raw vendor-payload retention and diagnostic access                               |
