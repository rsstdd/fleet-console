...
describe("schemaVersionSchema", () => {
  ...
  it("rejects any other version rather than reinterpreting it", () => {
    // An unsupported version must fail loudly. Accepting "2" under version 1
    // rules is the silent reinterpretation AGENTS.md forbids.
    for (const value of ["2", "0", "1.0", 1, null]) {
