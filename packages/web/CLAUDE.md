...
- Keep comments exceptional under ADR 39: exports, layer crossings, hooks, and coupling do
  not trigger prose, and any doc comment must preserve a non-obvious contract rather than
  restate its signature (ADR 28). Prefer focused test-first diffs.
